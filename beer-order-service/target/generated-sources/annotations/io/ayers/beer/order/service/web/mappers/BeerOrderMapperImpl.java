...
import io.ayers.beer.order.service.domain.BeerOrder;
import io.ayers.beer.order.service.domain.BeerOrder.BeerOrderBuilder;
import io.ayers.beer.order.service.domain.BeerOrderLine;
import io.ayers.beer.order.service.domain.Customer;
import io.ayers.beer.order.service.domain.OrderStatusEnum;
import io.ayers.beer.order.service.web.model.BeerOrderDto;
import io.ayers.beer.order.service.web.model.BeerOrderDto.BeerOrderDtoBuilder;
...
public class BeerOrderMapperImpl implements BeerOrderMapper {
    ...
    protected io.ayers.beer.order.service.web.model.OrderStatusEnum orderStatusEnumToOrderStatusEnum(OrderStatusEnum orderStatusEnum) {
        if ( orderStatusEnum == null ) {
            return null;
        }

        io.ayers.beer.order.service.web.model.OrderStatusEnum orderStatusEnum1;

        switch ( orderStatusEnum ) {
            case NEW: orderStatusEnum1 = io.ayers.beer.order.service.web.model.OrderStatusEnum.NEW;
            break;
            case READY: orderStatusEnum1 = io.ayers.beer.order.service.web.model.OrderStatusEnum.READY;
            break;
            case PICKED_UP: orderStatusEnum1 = io.ayers.beer.order.service.web.model.OrderStatusEnum.PICKED_UP;
            break;
    ...
    protected OrderStatusEnum orderStatusEnumToOrderStatusEnum1(io.ayers.beer.order.service.web.model.OrderStatusEnum orderStatusEnum) {
        if ( orderStatusEnum == null ) {
            return null;
        }
